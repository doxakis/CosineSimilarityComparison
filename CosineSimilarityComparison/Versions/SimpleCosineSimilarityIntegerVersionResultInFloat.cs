...
{
    public class SimpleCosineSimilarityIntegerVersionResultInFloat
	{
		public static float[][] ComputeDistances(int[][] dataSet, bool useMultipleThread = false, int maxDegreeOfParallelism = 0)
		{
		...
		public static float ComputeDistance(int[] attributesOne, int[] attributesTwo)
		{
			float dotProduct = 0;
